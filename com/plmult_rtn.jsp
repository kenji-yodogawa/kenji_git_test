...
<!-- *****************************************************************
		...
		呼出元：drinfoapv_inp.jsp
		        drinfompapv_upl.jsp (超重要)
		        ploptset_upl.jsp　（超重要）
		Auther	:k-mizuno
		Date	:2006-09-05
		       ...
		       2016-10-11 kaneshi select L.* 修正　カラム限定
		       　　　　　　　　　　　　　StringBuilder#setLength(0)対応
		       2016-10-19 kaneshi 出力するパラメータを定義する場所がおかしく修正しました。
******************************************************************** -->
