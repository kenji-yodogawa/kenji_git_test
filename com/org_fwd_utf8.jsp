...
<!-- ******************************************************
	...
	　　　　　　　　　　　　　　　　文字コードs-jisとutf-8をわけた。
	                   ...
	                   String#concat_speed_up
	2016-09-18 kaneshi StringBuilder化徹底
...
while(multtopnoTkn.hasMoreTokens()){
	...
	while(!strMultTopOrgId.equals("")){
		if(sbMultQry.length()==0){
			...
			.append(" and FromDate<='") .append(strMultSetDate) .append("'") //S2
